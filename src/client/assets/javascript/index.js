...
async function handleCreateRace() {
    ...
    if (playerId == undefined || trackId == undefined) {
        alert("Player Id OR Track Id may undefined");
        return;
    }
    ...
    try {
        ...
        console.log("Error handleCreateRace: " + err);
    }
}
...
async function accelerate(id) {
    ...
    const raceId = parseInt(id);
    return await fetch(`${SERVER}/api/races/${raceId}/accelerate`, {
            method: 'POST',
            ...defaultFetchOpts(),
        })
